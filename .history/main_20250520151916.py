...
def callback():
    ...
    if not code or not state:
        return "Error: Missing code or state in callback request."

    # Store the code and state in Redis
    redis_client.set(state, code)
    return f"Spotify authorization successful! Code: {code}, State: {state}"