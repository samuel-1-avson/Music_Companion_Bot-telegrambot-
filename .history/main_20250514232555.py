...
load_dotenv()
TOKEN = os.getenv("5983174648:AAEbMKWsCeAOF0IK2Cs_nUDWPPPLm1zlbEs")
OPENAI_API_KEY = os.getenv("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")
SPOTIFY_CLIENT_ID = os.getenv("96cf33dc19fd42d7960918fd28070222")
SPOTIFY_CLIENT_SECRET = os.getenv("98a98be8598844558c78526c642187f4")
GENIUS_ACCESS_TOKEN = os.getenv("FZySw-tMGKMl3fZ1CW0t4C_luUGqIXjaMELqh1u4IXiMDA2VTwhLWeHP8s3VjjYZ")
